    ...
    <div className="col-span-1 flex flex-col gap-y-4">
      <div className="rounded-lg bg-muted p-4">
        ...
        <ul className="flex flex-col gap-y-4">
          ...
          <li className="hidden text-center text-sm text-muted-foreground first-of-type:block">Задачи не найдены.</li>
        </ul>
    ...
    <div className="col-span-1 flex flex-col gap-y-4">
      <div className="rounded-lg border bg-white p-4">
        <div className="flex items-center justify-between">
          ...
          <Button title="Создать проект" variant="secondary" size="icon" onClick={createProject}>
            <PlusIcon className="size-4 text-neutral-400" />
          </Button>
        </div>
        ...
        <ul className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          ...
          <li className="hidden text-center text-sm text-muted-foreground first-of-type:block">Проекты не найдены.</li>
        </ul>
      </div>
    </div>
  );
    ...
    <div className="col-span-1 flex flex-col gap-y-4">
      <div className="rounded-lg border bg-white p-4">
        ...
        <ul className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <li className="hidden text-center text-sm text-muted-foreground first-of-type:block">Участники не найдены.</li>
        </ul>
      </div>
    </div>
  );
