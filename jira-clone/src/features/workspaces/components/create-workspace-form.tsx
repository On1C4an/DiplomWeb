  ...
  return (
    <Card className="size-full border-none shadow-none">
      <CardHeader className="p-7">
        <CardTitle className="text-xl font-bold">Создать рабочее пространство</CardTitle>

        <CardDescription>
          Создайте рабочее пространство для управления проектами и задачами.
        </CardDescription>
      </CardHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} type="text" placeholder="Название рабочего пространства" />
                    </FormControl>
