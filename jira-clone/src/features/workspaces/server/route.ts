    ...
    try {
      ...
      if (image instanceof File) {
        try {
          ...
          console.error('[CREATE_WORKSPACE_IMAGE]:', error);
          return ctx.json(
            {
      ...
      try {
        ...
        try {
          ...
          console.error('[CREATE_WORKSPACE_MEMBER]:', error);
          // Если не удалось создать членство, удаляем созданное рабочее пространство
      ...
      console.error('[CREATE_WORKSPACE_GENERAL]:', error);
      return ctx.json(
        {
